...
<head>
    ...
    <title>Pedagogue| Elearning</title>
...
<div class="wrapper">
    ...
    <nav id="sidebar">
        ...
        <ul class="list-unstyled components">
            ...
            <li>
                <a href="#examSubmenu" id="pedagogueexam" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">Exam</a>
            ...
            <li>
                <a href="#questionSubmenu" id="questions" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">Question</a>
    ...
    <div id="content">
        ...
        <form id="course-form" class="login-block" method="post" style="width: 100%;margin-bottom: 50px">
            ...
            <button id="submit-course" type="submit" value="${pedagogue.id}" class="buttonAlign" >Submit</button>
        </form>
        ...
        <form id="add-students" class="login-block" method="post" style="width: 50%;margin-top: 50px;float: left;">
            ...
            <button id="submit-students" type="submit" class="buttonAlign">Submit</button>
        </form>
        ...
        <form id="exam-form" class="login-block" method="post" style="width: 75%;margin-bottom: 60px">
            ...
            <label for="course"></label><select id="course" name="courseid" required>
            </select>
            ...
            <button value="${pedagogue.id}" id="submit-exam" type="submit" class="buttonAlign">Submit</button>
        </form>
        ...
        <form id="question-form" class="login-block" method="post" style="width: 75%;margin-bottom: 60px">
            ...
            <button id="submit-question" type="submit" value="${pedagogue.id}" class="buttonAlign">Submit</button>
        </form>
    </div>
</div>
